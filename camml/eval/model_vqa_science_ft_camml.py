...
vision_index = faiss.read_index("data/sqa_vision_flatIP.index")
sqa_llava_json_file = "data/sqa_train_post_memory_answer.json"
        ...
        if 'image' in line:
            ...
            if getattr(model.config, 'mm_use_im_start_end', False):
                ...
                qs = "This is the useful context information for this question: <image>, which contains " \
                      ...
                      "the following scientific question. The image for this question: " + DEFAULT_IMAGE_TOKEN + '\n' + \
                     "The question is: " + qs
            cur_prompt = '<image>' + '\n' + cur_prompt
            image_ret_list = []
            ...
            qs = "This is the useful context information for this question: <image>, which contains " \
                  "previous scientific question answering examples, please use this context information to answer" \
                  "the following scientific question. There is no image for this question. The question is: " + qs
            image_ret_list = []
            for image_ret_path in image_ret_path_list:
                image_ret = Image.open(image_ret_path)
                img_ret = image_processor.preprocess(image_ret, return_tensors='pt')['pixel_values'][0]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--icl-num", type=int, default=3)
